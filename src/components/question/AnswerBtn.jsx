        ...
        <DrawerContent backgroundColor="var(--secondary-color)">
          <DrawerHeader borderBottomWidth="1px">
            <Flex alignItems="center">
              <Text fontSize="2xl">Trả lời</Text>
              <Button
              ...
              >{isLoading ? <Spinner /> : 'Trả lời'}</Button>
            </Flex>
          </DrawerHeader>
          <DrawerCloseButton />
          <DrawerBody>
            <MarkdownContainer>
              <div className="utils">
                <Button
                  ...
                  _hover={{ opacity: 0.8 }}
                >Hiện {!isPreview ? 'bản loại bỏ' : 'bản đầy đủ'}</Button>
              </div>
              {!isPreview ? <textarea
                placeholder='Nhập câu trả lời của bạn vào đây (hỗ trợ trang trí Markdown)'
                value={answerBody}
